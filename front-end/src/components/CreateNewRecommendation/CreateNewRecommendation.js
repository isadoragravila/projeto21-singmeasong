...
export default function CreateNewRecommendation({ onCreateNewRecommendation = () => 0, disabled = false }) {
  ...
  return (
    <Container>
      <Input type="text" data-cy="name" placeholder="Name" value={name} onChange={e => setName(e.target.value)} disabled={disabled} />
      <Input type="text" data-cy="youtubeLink" placeholder="https://youtu.be/..." value={link} onChange={e => setLink(e.target.value)} disabled={disabled} />
